...
The Pekko runtime uses `scala.concurrent.Future` as its effect type. Use `FutureWorkflowContext` to define your workflow context, which automatically provides the `Effect[Future]` instance.
