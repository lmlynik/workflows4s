...
import workflows4s.example.withdrawal.{FutureWithdrawalWorkflow, WithdrawalData, WithdrawalSignal, WithdrawalWorkflow}
...
object FutureWithdrawalWorkflowService {
  ...
  class Impl(journal: Journal, wdRuntime: PekkoRuntime[WithdrawalWorkflow.Context.Ctx])(using
